package catastrophescroll.potion;
...
public abstract class PotionBase extends Potion {
    ...
    public PotionBase(String name, boolean isBadEffect, int liquidColor) {
        ...
        this.texture = new ResourceLocation(CatastropheScroll12.MODID, "textures/effects/" + name + ".png");
        this.setRegistryName(CatastropheScroll12.MODID, name);
        this.setPotionName("effects." + CatastropheScroll12.MODID + "." + name);
    }
