...
@Config(modid = CatastropheScroll12.MODID)
public class ForgeConfigHandler {
	...
	private static class EventHandler{
		...
		public static void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent event) {
			if(event.getModID().equals(CatastropheScroll12.MODID)) {
				ConfigManager.sync(CatastropheScroll12.MODID, Config.Type.INSTANCE);
			}
		}
	}
}